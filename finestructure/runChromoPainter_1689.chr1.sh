...
#$ -m beas
source ~/.bash_profile
ChromoPainterv2 -g ../merged.bi.lmiss90.ed.chr1.bgl.phase -t merged.bi.lmiss90.ed.inds.txt -a 0 0 -r recombRate/merged.bi.lmiss90.ed.chr1.recombfile  -n 9838.359 -M 0.01126963 -o cpOutput/merged.bi.lmiss90.ed.chr1.runD
