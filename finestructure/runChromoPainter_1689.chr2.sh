...
#$ -m beas
source ~/.bash_profile
ChromoPainterv2 -g ../merged.bi.lmiss90.ed.chr2.bgl.phase -t merged.bi.lmiss90.ed.inds.txt -a 0 0 -r recombRate/merged.bi.lmiss90.ed.chr2.recombfile  -n 9838.359 -M 0.01126963 -o cpOutput/merged.bi.lmiss90.ed.chr2.runD
